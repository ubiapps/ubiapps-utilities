...
exports.createWebinosJS = function(node_moduleDir, apiModules) {
    ...
    var webinosJS, webinosJSPath;
    var os = require('os');
//    webroot_Dir = path.join(node_moduleDir, "../web_root");
//    webinosJSPath = path.join(webroot_Dir, "webinos.js");
    webinosJSPath = path.join(wPath.webinosPath(), "wrt", "webinos.js");
    ...
    fs.writeFileSync(webinosJSPath,""); // Overwrite/create file
    webinosJS = fs.createWriteStream(webinosJSPath, { flags:"a", encoding:"utf8"});
    ...
    if(os.platform() === 'android')
    {
        ...
        fs.createReadStream(webinosJSPath).pipe(wrtJs);
    } 
};
