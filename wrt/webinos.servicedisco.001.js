...
(function () {
    ...
    var ServiceDiscovery = function (rpcHandler) {
        ...
        this.findServices = function (serviceType, callback, options, filter) {
            ...
            if (typeof RMModule !== 'undefined') typeMapCompatible['http://webinos.org/api/remotemanagement'] = RMModule;
            if (typeof DataModule !== 'undefined') typeMapCompatible['http://webinos.org/api/data'] = DataModule;
